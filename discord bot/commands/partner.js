    ...
    try {
      ...
      if (query === "lista" || query === "all") {
        const partnerChannels = new Map([
          ...
          ['lazafejek', {name: 'lazafejek', channelId: "1414027188952633444", messageId: ""}],
          ['tradecentral', {name: '༻ [ Trade Central ™ ] ༺', channelId: "1414027188952633444", messageId:""}],
          ['arettegesuralma', {name: 'MC】 ArettegesUralma', channelId: "1414027188952633444", messageId: ""}]
        ]);
      ...
      const partners = new Map([
        ['connectbot', {name: "ConnectBot", description: "Egy olyan szerver ami partnerséget köt minden kategóriába sorolt szerverrel. Szeretnénk egy olyan közösséget létre hozni ahová szívesen térnek vissza.", text: ["🌐 Csatlakozz a **ConnectHub**-hoz! \n \n Szeretnél a közösségeddel együtt növekedni, és egy megbízható, segítőkész csapattal dolgozni? 🚀 Nálunk a partneri kapcsolatok nem csak együttműködésről szólnak – egy igazi támogató közösséget kapsz mellé! \n \n 💡 Partneri előnyök: \n • Kiemelt promóció a szervereden \n  • Gyors támogatás és személyre szabott tanácsadás \n  • Exkluzív hozzáférés a fejlesztői és kreatív közösségünkhöz \n \n Ha szeretnél egy modern, profi és támogató közösség részese lenni, csatlakozz hozzánk még ma! ✨ \n \n 🚀Csatlakozz egy kitartó, segítőkész csapathoz, ahol nem csak partneri kapcsolatot kapsz – növekedünk veled együtt! \n \n ✨ Mit nyújtunk? \n  • Discord bot fejlesztés 🤖 \n  • Weboldal fejlesztés 💻 \n  • Profi támogatás és tippek mindenhez 🌱 \n \n Ne maradj le, építsük együtt a jövőt! 🔗"], invite: "https://discord.gg/RYEGUysXuD"}],
