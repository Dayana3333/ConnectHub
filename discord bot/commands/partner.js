    ...
    try {
      ...
      if (query === "lista" || query === "all") {
        const partnerChannels = new Map([
          ...
          ['szogáj', { name: 'Szogáj | ⋆˚✿˖°', channelId: "1414027188952633444", messageId: "1415365742907494462"}],
      ...
      const partners = new Map([
        ...
        ['szogáj', { name: "Szogáj | ⋆˚✿˖°", description: "Csatlakozz a Szogáj szerverhez, ahol jó közösség és szórakozás vár!", text: [ "Üdv a Szogáj közösségében! 👋", "Csatlakozz hozzánk és érezd magad otthon, a barátságos közösségünkben! 💖", "\n", "Amit kínálunk:", "▸ Baráti légkör és új ismeretségek 🌍", "▸ Hasznos botok és személyre szabható rangok 🤖", "▸ Témacsatornák minden érdeklődésnek 🎮", "▸ Biztonságos, moderált környezet 🛡️", "\n", "Csatlakozz now:", "▸ https://dsc.gg/kenyergyar3", "\n", "Unban kérelem: https://appeal.gg/VDEz6HGm9Z", "Weboldalunk: https://szogaj.netlify.app/", "Értesítés: @everyone @here", "\n", "Köszönjük, ha csatlakozol, és bízunk benne, hogy élvezni fogod az idődet közöttünk! 🙏", ], invite: "https://discord.gg/VDEz6HGm9Z" }],
...
['magicstock', { 
  ...
  invite: "https://discord.gg/pNdGYmk5tG" 
        ...
        ['gredark', { name:"Gredark GANG Community", description:"", text: [ 
